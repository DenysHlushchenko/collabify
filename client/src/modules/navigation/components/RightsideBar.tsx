...
const RightsideBar = () => {
  ...
  return (
    <section className="custom-scrollbar sticky top-0 right-0 flex h-screen w-60 flex-col gap-6 overflow-y-auto border-l border-l-gray-300 p-6 pt-36 max-xl:hidden">
      <div>
